...
pub async fn apply_playbook(playbook_path: &str, db_url: &str, dry_run: bool, rollback: bool) -> Result<()> {
...
pub async fn test_playbook(playbook_path: &str, db_url: &str) -> Result<()> {
...
pub async fn destroy_playbook(playbook_path: &str, db_url: &str) -> Result<()> {
